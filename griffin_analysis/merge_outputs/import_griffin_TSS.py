...
# use python .\import_griffin_TSS.py --folder ..\..\Results\griffin_results\75bp_Illumina_results_21-05-2023\
# purpose - to merge the individual griffin TSS outputs into one dataframe for downstream R analysis
...
merged_filename = f"TSS Griffin GC_corrected.coverage_{dt_string}.csv"

merged_df.to_csv(merged_filename, index=True)

print(f'The Griffin TSS GC_corrected.coverage results have been saved to the file {output_filename} & {merged_filename}')
